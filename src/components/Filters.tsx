...
function Filters(): JSX.Element {
	...
	function handleDataChange(value: Array<SelectValue<typeof Task>>) {
		dispatch(filtersActions.setData(fromSelectValue(value)))
	}

	function handleProblemChange(value: Array<SelectValue<typeof Type>>) {
		dispatch(filtersActions.setProblem(fromSelectValue(value)))
	}

	function handleModelChange(value: Array<SelectValue<typeof Output>>) {
	...
	return (
		<Row gutter={[4, 4]} justify="center" style={{ marginBottom: 12 }}>
			...
			{/* Second row */}
			<Select placeholder="Type of Task" enumerator={Task} handleChange={handleDataChange} value={filters.task} span={8} />
			<Select placeholder="Type" enumerator={Type} handleChange={handleProblemChange} value={filters.type} span={8} />
			<Select placeholder="Type of Output" enumerator={Output} handleChange={handleModelChange} value={filters.output} span={8} />
			...
			<Col span={8}>
				<Search
					placeholder="Search titles, venues, authors and so on"
